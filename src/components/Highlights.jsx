...
import titaniumDesign from '../assets/img/titanium-design.jpg';
import features from "../assets/img/ios-features.jpg";
import a18pro from "../assets/img/chip-a18-pro.jpg";
  ...
  return (
    <section className="bg-black py-20 px-6" id="design">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-2xl p-10 mb-16" id="performance">
        ...
        <div id="camera" className="text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="border-x border-gray-900 rounded-2xl p-8 hover:scale-105 transition-all duration-300">
